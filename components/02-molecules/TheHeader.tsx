...
export const TheHeader = () => {
  ...
  return (
    <header
      ...
      className="bg-[#F2F2F2] z-40 w-screen h-auto lg:w-auto lg:h-screen py-6 flex lg:flex-col justify-between items-start px-8 font-medium shadow fixed left-0 top-0"
    >
