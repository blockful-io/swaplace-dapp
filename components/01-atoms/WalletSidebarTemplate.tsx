...
export const WalletSidebarTemplate = ({
  ...
  return (
    <>
      <div
        className={cc([
          "fixed left-0 top-0 w-full h-screen z-30 backdrop-blur-sm transition-all duration-300",
      ...
      <div
        className={cc([
          "z-50 h-screen absolute right-0 top-0 rounded-tl-[20px] border-l border-t transition-transform duration-300 ease-in-out p-6",
          isDark
