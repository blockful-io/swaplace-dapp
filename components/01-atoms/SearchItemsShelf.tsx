    ...
    <div className="relative flex-grow">
      <input
        ...
        className={cc([
          ...
          theme == "light"
            ? "border-[#E4E4E4] bg-[#F6F6F6] hover:bg-[#F0EEEE] hover:border-[#AABE13] hover:shadow-[0_0_6px_1px_#00000014] focus:shadow-[0_0_6px_1px_#00000014] focus:border-opacity-100"
