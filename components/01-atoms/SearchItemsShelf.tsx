  ...
  return (
    <div className="relative flex-grow">
      <input
        ...
        type="search"
        className={cc([
          "flex items-center text-ellipsis pr-1 pl-9 rounded-lg max-w-[216px] h-8 gap-3 font-normal leading-5 text-sm not-italic placeholder-[#707572] border border-[#353836] opacity-80 dark:bg-[#282B29] transition duration-300 ease-in-out focus:outline-none",
          theme == "light"
