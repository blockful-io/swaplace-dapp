    ...
    return (
      <div className="w-[326px] h-full flex flex-col gap-4">
        <div className="flex items-center gap-2">
          <div className="ens-avatar-small bg-gray-700" />
          <div className="w-40 h-4 bg-gray-700 rounded-full" />
        </div>
        <div className="flex gap-4">
          <div className="card-token-medium !mx-0 !bg-gray-700" />
          <div className="card-token-medium !mx-0 !bg-gray-700" />
          <div className="card-token-medium !mx-0 !bg-gray-700" />
          <div className="card-token-medium !mx-0 !bg-gray-700" />
        </div>
        <div className="flex justify-between py-1 px-2">
          ...
          <div className="w-[135px] h-[20px] bg-gray-700 rounded-full" />
        </div>
      </div>
    );
  };
    ...
    return (
      <div className="flex justify-between px-3 p-2">
        <div className="flex p-small dark:!text-[#A3A9A5] items-center gap-2">
          <div className="w-[80px] !bg-gray-700 rounded-lg h-6" />
          <div className="w-[160px] !bg-gray-700 rounded-lg h-4" />
          <div className="w-[100px] !bg-gray-700 rounded-lg h-4" />
        </div>
        <div className="flex gap-2 justify-center items-center">
          <div className="w-[90px] bg-gray-700 h-6 rounded-full" />
          <div className="w-[12px] bg-gray-700 h-6 rounded-full" />
        </div>
      </div>
    );
  };
